    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a href="/notifications" class="nav-link">
                @if($count >= 1)
                <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="bell-exclamation" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 648 712" class="svg-inline--fa fa-bell-exclamation fa-w-14 fa-3x">
                    ...
                    <svg class="SVGBadge-svg" viewBox="0 0 5 45" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <text class="SVGBadge-number" x="16" y="12.5" text-anchor="middle">{{ $count }}</text>
                    </svg>
