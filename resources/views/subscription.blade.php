                        ...
                        <div class="btn-group mt-3">
                            <ul class="nav nav-pills">
                                <li class="nav-item mr-2">
                                    <a type="button" data-toggle="pill" class="btn btn-lg btn-outline-success" onclick="Monthly" href="#Monthly">
                                        Monthly
                                    </a>
                                </li>
                                <li class="nav-item ml-2">
                                    <a type="button" data-toggle="pill" class="btn btn-lg btn-outline-primary" onclick="Annually"  href="#Annually">
                                        Annually
                                    </a>
                                </li>
                            </ul>
